...
class TestAmenity(unittest.TestCase):
    ...
    def SetUpClass(self):
        """
        Sets the public class attributes of the test Amenity class back to 
        """
        Amenity.name = ""
    ...
    def test_pep8_conformance(self):
        """Tests that State conforms to pep8"""
    ...
    def test_class_method_presence(self):
        """Tests that all the Amenity methods are all present"""
        l1 = dir(Amenity)
    ...
    def test_class_attribute_presence(self):
        """Tests all the Amenity attributes are all present"""
        l1 = dir(Amenity)
        self.assertIn('name', l1)

    def test_instance_method_presence(self):
        """Tests that all Amenity instance has the same methods"""
        l1 = dir(Amenity())
        self.assertIn('__init__', l1)
        self.assertIn('save', l1)
        self.assertIn('to_dict', l1)
    ...
    def test_instance_attribute_presence(self):
        """Tests that all Amenity instance attributes are all present"""
        l1 = dir(Amenity())
        self.assertIn('id', l1)
    ...
    def test_docstring_presence(self):
        """Tests that all Module, Class, and methods all have a docstring"""
    ...
    def test_instantiation(self):
        """Tests all the proper instantiation of object 'User()'"""
    ...
    def test_save(self):
        ...
        # function for storage = FileStorage()
